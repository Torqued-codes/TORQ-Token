  ...
  return (
    <div className="glass-card rounded-2xl p-6 text-center">
      ...
      <div className="grid grid-cols-1 gap-3 mb-6">
        <div className="rounded-xl bg-charcoal-900/60 border border-charcoal-600 p-4 text-left">
      ...
      <button
        onClick={handleMine}
        disabled={!canMine}
        className="btn-metallic w-full rounded-xl py-4 font-bold text-lg disabled:opacity-40 disabled:cursor-not-allowed hover:brightness-105 transition"
      >
